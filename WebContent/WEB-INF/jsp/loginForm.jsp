	...
	<div class="page-lock">
		<div class="page-logo" style="margin-bottom: 2px">
			<a class="brand" href="login.html"
				style="font-size: 25px; color: #FFF;align=center"> <font color="#FFCC00">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;软件实训-人事管理系统</font><span
		...
		<form action="login" method="post" id="loginForm">
				...
				<div class="page-lock-info">
					...
					<c:choose>
						<c:when test="${requestScope.message == null }">
							<span style="padding-top: 5px" color="red" >请先登录再访问网站！</span>
						</c:when>
						<c:otherwise>
			...
			<div class="page-footer" style="color:  #FFF">
				 <b>2019 @ 软件1802班 http://www.csu.edu.cn</b>
			</div>
		</form>
	</div>
